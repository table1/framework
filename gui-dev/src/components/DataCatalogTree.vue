<template>
  <div>
    <div v-if="isGroup" :class="groupWrapperClass">
    ...
    <div v-else :class="leafWrapperClass">
      <div v-if="layout === 'card'" class="flex items-start justify-between gap-4">
        <div class="min-w-0">
        ...
        <div class="flex items-center gap-2 shrink-0">
          <span
            v-if="node.data?.type"
            class="inline-flex items-center rounded-full border border-gray-200 bg-white px-2.5 py-1 text-xs font-medium text-gray-600 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-200"
          >
            {{ node.data.type }}
          </span>
          <Button
      ...
      <div :class="layout === 'card' ? 'mt-5 space-y-4' : 'mt-5 space-y-5'">
        <div class="flex items-start gap-3">
          <CopyButton
...
const groupWrapperClass = computed(() => (
  isTopLevel.value
    ? 'mb-4 rounded-xl border border-gray-200 bg-white p-6 transition hover:border-gray-300 dark:border-gray-700/70 dark:bg-gray-900 dark:hover:border-gray-600'
...
const leafWrapperClass = computed(() => (
  'relative rounded-lg bg-gray-50 p-6 transition hover:bg-gray-100 dark:bg-gray-800/50 dark:hover:bg-gray-800/60 focus-within:ring-2 focus-within:ring-sky-200 dark:focus-within:ring-sky-500/40'
))
