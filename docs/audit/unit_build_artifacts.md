...
- Check for lingering caches under `_rendered/`, `outputs/private/cache/`, or other directories. Currently empty, but add README/.gitkeep files to explain their purpose after cleanup.
